...
public class JFrame extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        DefaultTableModel dt = (DefaultTableModel) jTable1.getModel();
        int N = recIntegral.size();
        ThreadRunable threadRunable[] = new ThreadRunable[N];

        for (int i = 0; i < N; i++) {
            String h = recIntegral.get(i).getUpperIntegral();
            String l = recIntegral.get(i).getLowerIntegral();
            String s = recIntegral.get(i).getIntegralStep();
            threadRunable[i] = new ThreadRunable(l, h, s);
            threadRunable[i].run();
        }

        for (int i = 0; i < N; i++) {
            String res;
            res = threadRunable[i].getResult();
            recIntegral.get(i).setResult(res);
            dt.setValueAt(recIntegral.get(i).getIntegralResult(), i, 3);
        }
